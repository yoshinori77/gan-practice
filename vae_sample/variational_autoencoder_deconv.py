...
def plot_results(models,
                 data,
                 batch_size=128,
                 model_name="vae_mnist", digit_size=64):
...
for picture in glob.glob(data_dirname):
    img = img_to_array(load_img(picture, target_size=(digit_size, digit_size)))
    x.append(img)
    y.append(0)
...
x_train, x_test, y_train, y_test = train_test_split(
    x, y, test_size=0.05, random_state=111)
# original_dim = 12288
...
if __name__ == '__main__':
    ...
    plot_results(models, data, batch_size=batch_size, model_name="vae_cnn", digit_size=64)
