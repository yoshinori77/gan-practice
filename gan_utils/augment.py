...
trains_dirname = os.path.join('..', 'dataset', 'labeled', 'キュビスム', 'trains')
valids_dirname = os.path.join('..', 'dataset', 'labeled', 'キュビスム', 'valids')
...
model_filename = os.path.join(
    'models', 'finding-pikachu_model_{val_loss:.2f}.h5')
...
predicted_dirname = os.path.join('..', 'dataset', 'predicted_キュビスム')
